    ...
    return (
        <div>
          ...
          <div className="text-white text-center pt-10">
                <h1 className="font-bold text-4xl">Customer reviews</h1> <br />
          ...
          <div className="flex flex-col max-w-xl p-8 shadow-sm rounded-xl lg:p-12 dark:bg-gray-50 dark:text-gray-800 space-y-3">
